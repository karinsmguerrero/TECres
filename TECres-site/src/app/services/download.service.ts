...
export class DownloadService {
  ...
  getCommissionReport() {
    this.http.get(this.rootURL + '/api/getCommissionReport', { responseType: 'arraybuffer' });
  }
  ...
  getSalesReport(startDate: string, endDate: string) {
    ...
    this.http.post(this.rootURL + '/api/getSalesReport', body, { responseType: 'arraybuffer' });
  }
