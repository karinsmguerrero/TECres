...
namespace TECres_api.Reports.DataSets {
    ...
    public partial class dsPrueba : global::System.Data.DataSet {
        ...
        public partial class personaDataTable : global::System.Data.TypedTableBase<personaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public personaRow AddpersonaRow(string nombre, string apellido, string usuario, string direccion, int id) {
            ...
            public int id {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'id\' de la tabla \'persona\' es DBNull.", e);
                    }
                }
                set {
...
namespace TECres_api.Reports.DataSets.dsPruebaTableAdapters {
    ...
    public partial class personaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[persona] ([nombre], [apellido], [usuario], [direccion], [id]) " +
                "VALUES (@nombre, @apellido, @usuario, @direccion, @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["pruebasConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT nombre, apellido, usuario, direccion, id FROM dbo.persona";
        ...
        public virtual int Fill(dsPrueba.personaDataTable dataTable) {
        ...
        public virtual dsPrueba.personaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsPrueba.personaDataTable dataTable = new dsPrueba.personaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsPrueba.personaDataTable dataTable) {
        ...
        public virtual int Insert(string nombre, string apellido, string usuario, string direccion, global::System.Nullable<int> id) {
            if ((nombre == null)) {
